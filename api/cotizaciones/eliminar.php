<?php
/**
 * SHALOM FACTURA - API Eliminar Cotización
 */
...
if (!auth()->can('cotizaciones.eliminar')) {
...
if (!$id) {
    Helpers::json(['success' => false, 'message' => 'ID de cotización requerido'], 400);
}

$cotizacionModel = new Cotizacion();
$result = $cotizacionModel->delete($id);
